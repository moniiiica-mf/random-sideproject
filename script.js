...
class ShoeCloset {
    ...
    initializeSampleData() {
        ...
        const sampleShoes = [
            new Shoe(1, "Balenciaga", "Black", "2022/01/12", "Images/Balenciaga_Shoe1.png"),
            new Shoe(2, "Balenciaga", "Pink", "2023/02/02", "Images/Balenciaga_Shoe2.png"),
            new Shoe(3, "Balenciaga", "Bright Green", "2019/03/31", "Images/Balenciaga_Shoe3.png"),
            new Shoe(4, "Balenciaga", "White", "2021/01/14", "Images/Balenciaga_Shoe4.png"),
            new Shoe(5, "Balenciaga", "Black", "2023/03/30", "Images/Balenciaga_Shoe5.png"),
            new Shoe(6, "Balenciaga", "Red", "2019/01/29", "Images/Balenciaga_Shoe6.png"),
            new Shoe(7, "Balenciaga", "Black", "2018/11/09", "Images/Balenciaga_Shoe7.png"),
            new Shoe(8, "Balenciaga", "Black and White", "2021/09/30", "Images/Balenciaga_Shoe8.png"),
            new Shoe(9, "Jimmy Choo", "Black", "2019/12/25", "Images/JimmyChoo_Shoe1.png"),
            new Shoe(10, "YSL", "Black", "2025/08/16", "Images/YSL_Shoe1.png"),
            new Shoe(11, "YSL", "Green", "2020/07/20", "Images/YSL_Shoe2.png"),
            new Shoe(12, "YSL", "Black", "2024/05/28", "Images/YSL_Shoe3.png"),
            new Shoe(13, "YSL", "Black and White", "2022/04/15", "Images/YSL_Shoe4.png"),
            new Shoe(14, "YSL", "White", "2025/05/08", "Images/YSL_Shoe5.png"),
            new Shoe(15, "YSL", "Black", "2022/01/10", "Images/YSL_Shoe6.png"),
            new Shoe(16, "YSL", "Brown and Black", "2022/05/20", "Images/YSL_Shoe7.png"),
            new Shoe(17, "YSL", "Black", "2025/03/11", "Images/YSL_Shoe8.png"),
            new Shoe(18, "YSL", "Black", "2020/07/26", "Images/YSL_Shoe9.png"),
            new Shoe(19, "Jimmy Choo", "White", "2019/10/10", "Images/JimmyChoo_Shoe2.png"),
            new Shoe(20, "Jimmy Choo", "White", "2022/06/23", "Images/JimmyChoo_Shoe3.png"),
            new Shoe(21, "Jimmy Choo", "Pink and Silver", "2018/04/28", "Images/JimmyChoo_Shoe4.png"),
            new Shoe(22, "Jimmy Choo", "Black", "2021/02/28", "Images/JimmyChoo_Shoe5.png"),
            new Shoe(23, "Dior", "Black", "2019/12/17", "Images/Dior_Shoe1.png"),
            new Shoe(24, "Dior", "Black", "2021/03/14", "Images/Dior_Shoe2.png"),
            new Shoe(25, "Dior", "Pink and White", "2021/07/16", "Images/Dior_Shoe3.png"),
            new Shoe(26, "Dior", "White", "2025/08/23", "Images/Dior_Shoe4.png"),
            new Shoe(27, "Dior", "Pink and White", "2018/09/29", "Images/Dior_Shoe5.png"),
            new Shoe(28, "Dior", "Dirty White", "2024/12/22", "Images/Dior_Shoe6.png"),
            new Shoe(29, "Dior", "Black and White", "2021/02/01", "Images/Dior_Shoe7.png"),
            new Shoe(30, "Dior", "Brown", "2022/10/27", "Images/Dior_Shoe8.png")
          ];
